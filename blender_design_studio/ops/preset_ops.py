...
class BDS_OT_load_garment_preset(bpy.types.Operator):
    ...
    preset: EnumProperty(
        ...
        items=[
            ...
            ('cardigan', 'Cardigan', 'Open-front cardigan with long sleeves'),
            ('crop_top', 'Crop Top', 'Short cropped top'),
            ('pencil_skirt', 'Pencil Skirt', 'Fitted pencil skirt'),
            ('trench_coat', 'Trench Coat', 'Long trench coat with sleeves'),
            ('polo', 'Polo Shirt', 'Polo shirt with collar and short sleeves'),
            ('wrap_dress', 'Wrap Dress', 'Wrap-style dress with overlapping panels'),
            ('cargo_shorts', 'Cargo Shorts', 'Knee-length cargo shorts'),
            ('blazer', 'Blazer', 'Tailored blazer with lapels'),
            ('vest', 'Vest', 'Sleeveless vest'),
            ('jumpsuit', 'Jumpsuit', 'One-piece jumpsuit with full-length legs'),
            ('kimono', 'Kimono', 'Traditional kimono with wide sleeves and obi'),
        ],
        default='tshirt',
    )
